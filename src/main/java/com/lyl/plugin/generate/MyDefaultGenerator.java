...
import com.lyl.plugin.utils.Random;
...
//    private static final Logger LOGGER = LoggerFactory.getLogger(MyDefaultGenerator.class);
    ...
    public void paddingTemplate(TemplateParamVO templateParamVO,String outPutDir) throws Exception {
        ...
        System.out.println("22222222"+prepareTemplateData().getHost());
        Writer out = new FileWriter(new File(outPutDir+"/"+prepareTemplateData().getHost()+".jmx"));
...
//                    System.out.println("2222222"+param.getName());

                    Random r=new Random();
                    String variableName=r.randomdota(param.getSchema().getType(),param.getName());
//                    String variableName=operation.getOperationId()+"."+param.getName();
 //                   String variableName="${__RandomString(10,abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789,randomString)}";
