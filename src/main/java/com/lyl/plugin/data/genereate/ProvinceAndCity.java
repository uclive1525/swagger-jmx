...
public class ProvinceAndCity {
    ...
    public static String getProvinceAndCity() {
        return  provinceCityList.get(
            RandomUtils.nextInt(0, provinceCityList.size()));
    }
    ...
    public static String getCity() {
        return  cityNameList.get(
            RandomUtils.nextInt(0, cityNameList.size()));
    }
    ...
    public static String getCityAddress() {
        ...
        return getProvinceAndCity()+area[randomAreaNum]+road[randomRoadNum]+num+"号"+home[randomHomeNum];
    }
