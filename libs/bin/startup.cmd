...
set SWAGGER_LOCATION=http://47.97.154.153:8201/hr/v2/api-docs

rem File directory for JMeter script output
set JMX_FILE_DIR=/media/zgq/data/code/git.youlu.com/dev-test-team-project/api-test/swaggerTest/swagger2jmx-plugin/src/main/resources/jmx/
